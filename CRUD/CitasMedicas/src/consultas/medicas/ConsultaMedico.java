        ...
        try {
           ...
           ResultSet rsu=st.executeQuery(SQL);
            ...
            while (rsu.next()) {
                ...
                registros [0]= rsu.getString("ID_MEDICO");
                registros [1]= rsu.getString("MED_NOMBRE");
                registros [2]= rsu.getString("MED_APELLIDO");
                registros [3]= rsu.getString("MED_CELULAR");
                registros [4]= rsu.getString("MED_CORREO");
                registros [5]= rsu.getString("MED_DIRECCION");
                registros [6]= rsu.getString("MED_SEXO");
                registros [7]= rsu.getString("MED_FECHA_NACIMIENTO");
                
            modelo.addRow(registros);
            }
           tablaconsulta.setModel(modelo);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Error al mostrar los datos del perosnla administrativo" + e.getMessage());
        }
    }
